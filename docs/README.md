...
This is the standalone WorldCodes Canvas documentation application built with Next.js and Fumadocs.
...
MDX content is stored under `content/docs` and rendered by the local Fumadocs configuration.
