export default {
    ...
    agent: {
        ...
        connect: { pluginTitle: "WorldCodes Local Agent (optional)", pluginText: "The Agent needs access to local Codex, Skills, and workspaces, so it runs only on the user's computer. Install and start the local bridge to connect; image and video generation do not require the Agent.", learnMore: "Read the in-site Agent guide", title: "Connect local Agent", description: "Use this only after installing WorldCodes Canvas Agent.", webConnection: "Local connection", autoDiscover: "The site reads the local URL and Connect token automatically; enter them manually only if discovery fails.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
