export default {
    ...
    apiReferenceDimensions: { image: "Each MiniMax H3 reference-image edge must be 256–5760 px (current: {{width}}×{{height}}).", video: "Each MiniMax H3 reference-video edge must be 256–5760 px (current: {{width}}×{{height}})." },
    common: {
        cancel: "Cancel",
        save: "Save",
        edit: "Edit",
    ...
    videoWorkbench: {
        ...
        referenceLimit: "The current asset type or model has reached its reference limit",
        referenceUploadFailed: "Failed to read the reference asset. Upload it again.",
        imageRole: "Reference image role",
        roleReference: "Reference image",
        roleFirstFrame: "First frame",
        roleLastFrame: "Last frame",
        h3ReferencesOnly: "Reference video, audio, and first/last-frame roles require MiniMax H3. Switch models or remove those assets.",
        standardImageLimit: "The current video model supports up to 7 regular reference images",
        clipboardEmpty: "No readable images found on the clipboard",
        clipboardAdded: "Added {{count}} reference images",
    ...
    canvas: {
        ...
        export: { defaultProjectName: "WorldCodes Canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>WorldCodes Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by WorldCodes Canvas, grouped by object store.",
            ...
            mainDatabase: "WorldCodes Canvas data",
        ...
        importedDirectConfig: "Provider settings imported",
        importFailed: "Failed to read the settings file",
        saved: "Settings saved",
        savedContinue: "Settings saved. Continue with your previous request.",
        channels: {
            description: "Choose a protocol and models, then assign image, video, text, or audio capabilities. WorldCodes production uses the same-origin Relay by default.",
            add: "Add provider",
        ...
        channelEditor: {
            ...
            modelDescription: "{{count}} selected; assign a capability to each model.",
            selectModels: "Sync / select models",
            syncModels: "Sync available models",
        ...
        modelSelect: {
            ...
            description: "Models come from this provider's /v1/models endpoint. WorldCodes Tokens apply Auto groups and model limits; add names manually when the endpoint is unavailable.",
    ...
    agent: {
        ...
        connect: { pluginTitle: "Option 1: Use the WorldCodes Codex plugin", pluginText: "Install the WorldCodes-owned Canvas plugin, then enter “Open WorldCodes Canvas” in a new Codex task. The plugin starts its own MCP and, when needed, the local Agent, the official site, and the connection details.", directTitle: "Option 2: Run WorldCodes Agent directly", directText: "Without the Codex plugin, run the self-hosted WorldCodes Agent command below, then return here to connect. The Local URL and Connect token are normally discovered automatically.", commandCopied: "Command copied", pluginReminder: "WorldCodes plugin note", pluginReminderText: "Installing the plugin adds WorldCodes Canvas tools to the Codex context. Running the Agent directly only provides the web connection and chat; it does not install MCP. Image/video generation and asset management do not require the Agent.", removePlugin: "Remove plugin", removeMcp: "Remove legacy manual MCP", copyCommand: "Copy command", title: "Connect WorldCodes Agent", description: "Choose the connection method that fits your workflow.", webConnection: "Web connection", autoDiscover: "The Local URL and Connect token are discovered automatically by default. Enter them manually only if discovery fails.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
