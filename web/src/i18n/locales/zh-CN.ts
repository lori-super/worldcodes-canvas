export default {
    ...
    agent: {
        ...
        connect: { pluginTitle: "WorldCodes 本地 Agent（可选）", pluginText: "Agent 需要访问本机 Codex、Skills 与工作区，因此只能运行在用户电脑。自有安装包发布前保持关闭即可，不影响生图和视频生成。", learnMore: "查看 Agent 站内说明", title: "连接本地 Agent", description: "仅在已安装 WorldCodes Canvas Agent 时使用。", webConnection: "本机连接", autoDiscover: "默认读取本机 Local URL 和 Connect token，失败时可手动填写。", disconnect: "断开", connect: "连接", localAddress: "本地地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现，或手动填入 Connect token" },
